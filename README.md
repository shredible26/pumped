...
### For 347:
1. Make sure that (3) Requirements are met. Add object storage / other cloud components. Figure out presentation/live demo. Make sure app meets ALL requirements in master-requirements. 
